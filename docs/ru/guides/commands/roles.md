...
Команда `gotr roles` работает с ролями и разрешениями.

## Что делает

- Управляет ролями и правами.
- Помогает централизованно контролировать уровень доступа.
- Используется в задачах администрирования и security-audit.
