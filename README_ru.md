...
> **Актуальная версия: v2.5.0** — См. [CHANGELOG](CHANGELOG.md)

## Обзор

`gotr` предоставляет комплексный инструментарий для работы с TestRail:

- **Операции с данными** — Получение и управление тест-кейсами, сьютами, секциями, shared steps, ранами и результатами
...
|-------------|----------|
| **Полное покрытие API** | Поддержка всех эндпоинтов TestRail API v2 |
