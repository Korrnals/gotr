...
Language: Русский | [English](../../../en/guides/commands/other.md)
...
Команда `gotr other` объединяет редкие и legacy-операции.

## Что делает

- Содержит редко используемые и legacy-операции.
- Даёт доступ к endpoint-ам, которые не входят в основные группы.
- Полезен для точечных задач совместимости и миграций.
