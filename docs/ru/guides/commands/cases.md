...
Команда `gotr cases` управляет тест-кейсами и связанными операциями.

## Что делает

- Управляет жизненным циклом тест-кейсов.
- Позволяет читать, создавать, обновлять и массово обрабатывать кейсы.
- Закрывает основные CRUD-сценарии по case-ресурсам.
