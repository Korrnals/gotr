...
Команда `gotr configurations` работает с конфигурациями и набором параметров.

## Что делает

- Управляет конфигурациями тестирования.
- Помогает поддерживать варианты окружений и комбинаций параметров.
- Используется при матричном планировании прогонов.
...
gotr configurations get --help

# Базовый вызов
gotr configurations --json
```
