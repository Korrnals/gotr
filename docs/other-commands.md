...
Все базовые команды реализованы:

- `add` — создание ресурсов (projects, suites, sections, cases, runs)
...
- `gotr milestone` — управление майлстоунами
- `gotr plan` — управление тест-планами
- `gotr test` — управление тестами
- `gotr config` — управление конфигурациями
- `gotr user` — управление пользователями
- `gotr report` — работа с отчётами

> **Примечание:** Все 106 endpoint'ов TestRail API уже реализованы в Client Layer.
> CLI команды будут добавлены последовательно в Stage 5.
