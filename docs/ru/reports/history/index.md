...
Language: Русский | [English](../../../en/reports/history/index.md)
...
Временная шкала решений, волн разработки и итоговые аудиты.

- [Layer 2 Final Report](layer2-final-report.md) — итоговый отчёт второго слоя
- [Wave 5 UI Coverage](wave5-ui-coverage-implementation.md) — волна 5, покрытие UI
