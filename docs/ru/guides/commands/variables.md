...
Language: Русский | [English](../../../en/guides/commands/variables.md)
...
Команда `gotr variables` управляет переменными и значениями.

## Что делает

- Управляет переменными и параметрами.
- Позволяет централизовать переиспользуемые значения.
- Используется для гибкой настройки сценариев и шаблонов.
