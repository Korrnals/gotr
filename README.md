...
- [Documentation](docs/index.md)
  - [Guides](docs/en/guides/index.md)
    ...
    - [Commands Index](docs/en/guides/commands/index.md)
      ...
      - [report (v3.3)](docs/en/guides/commands/report.md)
      - [cleanup (v3.3)](docs/en/guides/commands/cleanup.md)
    - [Instructions](docs/en/guides/instructions/index.md)
      - [Reports lifecycle (v3.3)](docs/en/guides/instructions/reports-lifecycle.md)
      - [Retention & cleanup runbook (v3.3)](docs/en/guides/instructions/retention-and-cleanup-runbook.md)
      - [TLS: insecure → ca_bundle (v3.3)](docs/en/guides/instructions/tls-ca-bundle-migration.md)
