...
Команда `gotr bdds` работает с BDD-данными кейсов.

## Что делает

- Работает с BDD-шагами кейсов.
- Позволяет синхронизировать сценарии Given/When/Then.
- Используется в командах, где тест-дизайн ведётся в BDD-формате.
