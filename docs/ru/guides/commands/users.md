...
Команда `gotr users` работает с пользователями и их атрибутами.

## Что делает

- Управляет пользователями и их атрибутами.
- Помогает автоматизировать онбординг/оффбординг.
- Используется для синхронизации данных пользователей между системами.
