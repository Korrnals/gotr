...
Language: Русский | [English](../../../en/guides/commands/tests.md)
...
Команда `gotr tests` работает с наборами тестов и массовыми операциями.

## Что делает

- Выполняет массовые операции с тестами run.
- Ускоряет обработку больших наборов тестов.
- Подходит для пакетных сценариев обновления статусов и метаданных.
