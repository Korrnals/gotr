...
Language: [Русский](../../../ru/guides/commands/other.md) | English
...
The `gotr other` command groups rare and legacy-oriented operations.

## What it does

- Handles API operations for the `other` command scope.
