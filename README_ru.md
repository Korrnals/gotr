...
- [Документация](docs/index.md)
  - [Гайды](docs/ru/guides/index.md)
    ...
    - [Каталог команд](docs/ru/guides/commands/index.md)
      ...
      - [report (v3.3)](docs/ru/guides/commands/report.md)
      - [cleanup (v3.3)](docs/ru/guides/commands/cleanup.md)
    - [Инструкции](docs/ru/guides/instructions/index.md)
      - [Жизненный цикл отчётов (v3.3)](docs/ru/guides/instructions/reports-lifecycle.md)
      - [Retention и cleanup runbook (v3.3)](docs/ru/guides/instructions/retention-and-cleanup-runbook.md)
      - [TLS: insecure → ca_bundle (v3.3)](docs/ru/guides/instructions/tls-ca-bundle-migration.md)
