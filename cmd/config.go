...
// editSubCmd - подкоманда "view" - для быстрого редактирования содержимого конфига
...
Если EDITOR не задан — используется fallback (vim/nano на Linux, notepad на Windows).
