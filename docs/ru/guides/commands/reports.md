...
Language: Русский | [English](../../../en/guides/commands/reports.md)
...
Команда `gotr reports` получает отчёты TestRail.

## Что делает

- Получает отчёты и агрегированную аналитику.
- Даёт быстрый доступ к метрикам качества и прогресса.
- Используется для подготовки статусов и релизной отчётности.
