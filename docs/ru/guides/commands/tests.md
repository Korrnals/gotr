...
## Обзор
Управление тестами (tests) — результатами выполнения тест-кейсов
в тестовых прогонах.
...
| Подкоманда | Описание |
| --- | --- |
| `get` | Получить информацию о тесте |
| `list` | Получить список тестов прогона |
| `update` | Обновить тест |

## Флаги

```text
-h, --help   справка для tests
```
