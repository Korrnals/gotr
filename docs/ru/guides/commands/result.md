...
Команда `gotr result` добавляет и читает результаты выполнения тестов.

## Что делает

- Добавляет результаты тестов в run.
- Поддерживает массовую отправку статусов и комментариев.
- Используется в автотестах и интеграции с внешними раннерами.
