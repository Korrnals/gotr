...
14. `TestMessage_AllVariants` - All message functions (Info, Success, Warning, Error, Phase, Stat, Section)

#### Formatting Functions (2 tests):
15. `TestFmtDuration_EdgeCases` - Duration formatting boundaries
16. `TestFmtCount_EdgeCases` - Count formatting boundaries
