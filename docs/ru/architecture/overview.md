...
Language: Русский | [English](../../en/architecture/overview.md)
...
Подробнее: [docs/architecture/concurrency.md](./concurrency.md)
...
Подробнее: [docs/architecture/recursive-parallelization-plan.md](./recursive-parallelization-plan.md)
...
│   ├── index.md                 #   Хаб документации
│   ├── guides/                  #   Установка, конфигурация, команды
│   │   ├── commands/            #     GET/SYNC/other
│   │   ├── interactive-mode.md  #     Интерактивный режим
│   │   └── progress.md          #     Система прогресса
│   ├── architecture/            #   Архитектура и стандарты
...
│   ├── operations/              #   Release-процесс
│   └── reports/                 #   Аудиты и stage-отчеты
